...
const NotFound = () => {
    return (
        <>
            <Header />
            <div className="flex flex-col items-center justify-center h-[calc(100vh-64px)] bg-gradient-to-br from-blue-100 via-blue-100 to-blue-50 text-gray-800 overflow-auto">
